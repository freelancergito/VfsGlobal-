     ...
     function Q(t) {
         ...
         if (
             ((b.innerHTML = _.map(function(t) {
                     return '<option value="'.concat(t.code, '" selected>').concat(t.label, "</option>");
             ...
             (function(t) {
                 ...
                 "bottom-right" === l
                     ...
                     h.addEventListener("click", function(e) {
                         ...
                         //Added by Jitu
                         //Static URL
                         // url2 = "https://dev.d1i7ia1a6aebjl.amplifyapp.com/ind/ar/bgr/visa-type";
                         // console.log(url2)
                         // let pathSegments = url2.split('/');
                         //Static URL End
                         let pathSegments = window.location.pathname.split('/');
                         //    console.log(url2)
                         const languageSelect = document.getElementById('asw-language');
                         let thirdSegment = pathSegments[2]; // Index 3 gives you the 4th segment, so use index 2 for the 3rd segment
                         // console.log(thirdSegment);
                         languageSelect.value = thirdSegment;
                         const languageSelect1 = document.getElementById('asw-language');
                         const selectedValue = languageSelect1.value;
                         if (selectedValue != "") {
                             languageSelect.value = thirdSegment;
