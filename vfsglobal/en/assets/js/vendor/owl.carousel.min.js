! function(h, i, n, a) {
    ...
    l.Defaults = {
        ...
        return this.settings.freeDrag || h.each(r, h.proxy(function(t, e) {
            return e - 30 < i && i < e + 30 ? n = t : "right" === s && e - o - 30 < i && i < e - o + 30 ? n = t + 1 : this.op(i, "<", e) && this.op(i, ">", r[t + 1] !== a ? r[t + 1] : e - o) && (n = "left" === s ? t + 1 : t), -1 === n
